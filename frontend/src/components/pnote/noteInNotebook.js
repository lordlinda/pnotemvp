...
class NoteEditor extends Component {
 ...
 // console.log('button clicked')
  ...
  if(note.body.length > 8){
    ...
    console.log(id)
     await this.props.noteInNotebook(id,note)
     //and if we have create the note successfully we are redirected to the notebook page
    this.props.history.push('/notebook/'+id)
